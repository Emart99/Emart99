    ...
    return (
        <div className="container">
            <section className="content grid grid-cols-1 md:grid-cols-2 w-full min-h-screen flex  items-center">
                ...
                <img className="coffe-cup m-auto " src="https://www.picng.com/upload/mug_coffee/png_mug_coffee_12098.png" alt="..." />
                </div>
            ...
            <section className=" bg-base-300 grid grid-cols-1 md:grid-cols-2 w-full min-h-screen flex items-center bg-base-100">
                <div className="">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen flex items-center   w-full">
                <div className="flex justify-center items-center flex-col  text-2xl ">
                    <h2 className="w-3/4 my-3 font-semibold">Difficult</h2>
                    <p className="w-3/4">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen flex items-center ">
                <div className="flex items-center justify-center">
                ...
                <div className="flex justify-center items-center flex-col  text-2xl ">
                    <h2 className="w-3/4 my-3 font-semibold">RampApp</h2>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen flex items-center">
                <div className="flex justify-center items-center flex-col  text-2xl ">
                    <h2 className="w-3/4 my-3 font-semibold">iNF-dsbot</h2>
                    <p className="w-3/4">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 w-full md:min-h-[80vh] min-h-screen flex items-center bg-base-300 bg-base-100">
